...
public class BlockchainController {
    ...
    /**
     * Constructor
     * @param numberOfBlocks amount of blocks to create.
     */
    public BlockchainController(int numberOfBlocks) {
    ...
    /**
     * entry point invoked by Main after creation of
     */
    public void run() {
        try {
            generateBlockchain();
    ...
    /**
     * validates a given blockchain by checking the previousHash field matches with the hash of the next block.
     ...
     */
    private boolean validateBlockchain(Blockchain blockchain) {
